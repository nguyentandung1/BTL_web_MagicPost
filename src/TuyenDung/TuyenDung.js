...
function TuyenDung() {
    useEffect(
        function (){
          document.title = "Magic Post TUYỂN DỤNG nhiều vị trí – THU NHẬP tới 20 TRIỆU/tháng";
          //document.body.style.background= "linear-gradient(0.25turn, #3f87a6, #ebf8e1, #f69d3c)"
        }
      );  

    var serviceName = "Magic Post TUYỂN DỤNG nhiều vị trí – THU NHẬP tới 20 TRIỆU/tháng";
    var serviceTitle = "MAGIC POST TUYỂN DỤNG NHIỀU VỊ TRÍ – THU NHẬP TỚI 20 TRIỆU/THÁNG";
    return (
        <div>
            <HeadBar />
            <HeadMenu />
